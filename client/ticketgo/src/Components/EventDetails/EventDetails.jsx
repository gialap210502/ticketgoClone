                                    ...
                                    <div className='col-md-8'>
                                        <div>
                                                                            ...
                                                                            <div className="col-3">
                                                                                <div className="input-group mb-3 input-group-sm">
                                                                                    <a
                                                                                        ...
                                                                                        onClick={() => {
                                                                                            handleAddItem(item.fields.id, item.fields["Product Name"], priceItem);
                                                                                            handleAddAmount(priceValue);
                                                                                        }}
                                                                                    >
                                                                                        +
                                                                                    </a>
                                            ...
                                            {ticketList?.map((TicketChosen, index) => {
                                                const priceTicketValue = extractPrice(TicketChosen.price);
                                                return (
                                                    <div className="row" style={{ paddingTop: '20px' }}>
                                                        <div class="col-8 border" >
                                                            <span className="col-6 border-end">{TicketChosen.price}</span>
                                                        </div>
                                                        ...
                                                        <div class="col-1 border" style={{ color: '#ff672a', fontWeight: 'bold', float: 'right', paddingTop: '7px' }}>
                                                            <a
                                                                onClick={() => {
                                                                    handleDeleteItem(TicketChosen.productName, TicketChosen.price);
                                                                    handleMinusAmount(priceTicketValue);
                                                                }}
